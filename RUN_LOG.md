...
- Pooled loader: 33 plates, 92 episodes, 23 new chemistries, validation 92/92.
  - R-P1: 3 combined-LED episodes excluded under the literal P-I2. Supply is now 89 episodes, 22 new chemistries, 36 in total.
...
- A3 scored: 468/468 cells, 0 coverage failures.
  ...
  - Floors: cls_gp 0.4625, cls_xrd 0.488, fm_xrd 0.486, chance 0.442 (corrected from the ledger; an earlier line typed from memory).
